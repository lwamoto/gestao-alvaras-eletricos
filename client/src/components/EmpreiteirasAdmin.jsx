      ...
      <div className="bg-white dark:bg-[#1e2127] border border-gray-200 dark:border-white/10 rounded-md shadow-sm p-6 sm:p-8 mb-6">
        <form onSubmit={handleAdicionar} className="flex items-end gap-3">
          ...
          <button
            ...
            className="inline-flex items-center gap-2 px-5 py-2.5 bg-copel-laranja text-white text-sm font-medium rounded hover:brightness-90 disabled:bg-gray-200 dark:disabled:bg-white/10 disabled:text-copel-cinza-medio disabled:cursor-not-allowed transition-colors cursor-pointer shrink-0"
          >
            <Plus size={16} />
            Adicionar
          </button>
        ...
        {erro && (
          <div className="mt-4 flex items-center gap-2 px-3.5 py-2.5 bg-red-50 dark:bg-red-500/10 border border-red-200 dark:border-red-500/30 text-red-700 dark:text-red-400 rounded text-sm">
            <AlertCircle size={16} />
            {erro}
          </div>
        )}
      ...
      <div className="bg-white dark:bg-[#1e2127] border border-gray-200 dark:border-white/10 rounded-md shadow-sm overflow-hidden">
        {carregando ? (
          ...
          <div className="p-8 text-center">
            <Building2 size={28} className="mx-auto text-gray-300 dark:text-white/15 mb-2" />
                ...
                <div className="flex items-center gap-3">
                  ...
                  <span
                    className={`inline-flex items-center px-2 py-0.5 text-[11px] font-medium rounded ${
                      emp.ativo ? 'bg-green-50 dark:bg-green-500/15 text-green-700 dark:text-green-400' : 'bg-copel-cinza text-copel-cinza-medio'
                    }`}
                  >
